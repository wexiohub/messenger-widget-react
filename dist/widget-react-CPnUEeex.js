...
import { d as e, w as t, x as n, y as r } from "./widget-react-B9XrHKqv.js";
import { $ as i, C as a, H as o, M as s, N as c, R as l, i as u, n as d, t as f, w as p } from "./widget-react-BFgpQWPW.js";
import { i as m, n as h, t as g } from "./widget-react-BGCZpMUT.js";
...
var D = /* @__PURE__ */ t(u(), 1), O = /* @__PURE__ */ function(e) {
...
var M = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u, ie = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u, ae = {};
function oe(e, t) {
	return ((t || ae).jsx ? ie : M).test(e);
}
//#endregion
//#region node_modules/hast-util-whitespace/lib/index.js
var se = /[ \t\n\f\r]/g;
function ce(e) {
	return typeof e == "object" ? e.type === "text" ? le(e.value) : !1 : le(e);
}
function le(e) {
	return e.replace(se, "") === "";
}
...
ue.prototype.normal = {}, ue.prototype.property = {}, ue.prototype.space = void 0;
//#endregion
...
var pe = /* @__PURE__ */ n({
	boolean: () => P,
	booleanish: () => F,
	commaOrSpaceSeparated: () => R,
	commaSeparated: () => ge,
	number: () => I,
	overloadedBoolean: () => he,
	spaceSeparated: () => L
}), me = 0, P = z(), F = z(), he = z(), I = z(), L = z(), ge = z(), R = z();
function z() {
	return 2 ** ++me;
}
//#endregion
//#region node_modules/property-information/lib/util/defined-info.js
var _e = Object.keys(pe), ve = class extends N {
	constructor(e, t, n, r) {
		let i = -1;
		if (super(e, t), ye(this, "space", r), typeof n == "number") for (; ++i < _e.length;) {
			let e = _e[i];
			ye(this, _e[i], (n & pe[e]) === pe[e]);
		}
	}
};
...
function be(e) {
	...
	for (let [r, i] of Object.entries(e.properties)) {
		...
		e.mustUseProperty && e.mustUseProperty.includes(r) && (a.mustUseProperty = !0), t[r] = a, n[fe(r)] = r, n[fe(a.attribute)] = r;
	}
...
function Ue(e) {
	return !e || typeof e != "object" ? "" : "position" in e || "type" in e ? Ge(e.position) : "start" in e || "end" in e ? Ge(e) : "line" in e || "column" in e ? We(e) : "";
}
function We(e) {
	return Ke(e && e.line) + ":" + Ke(e && e.column);
}
function Ge(e) {
...
var qe = {}.hasOwnProperty, Je = /* @__PURE__ */ new Map(), Ye = /[A-Z]/g, Xe = new Set([
	"table",
	"tbody",
	"thead",
	"tfoot",
	"tr"
]), Ze = new Set(["td", "th"]), Qe = "https://github.com/syntax-tree/hast-util-to-jsx-runtime";
function $e(e, t) {
...
function et(e, t, n) {
	if (t.type === "element") return tt(e, t, n);
	if (t.type === "mdxFlowExpression" || t.type === "mdxTextExpression") return nt(e, t);
	if (t.type === "mdxJsxFlowElement" || t.type === "mdxJsxTextElement") return it(e, t, n);
	if (t.type === "mdxjsEsm") return rt(e, t);
	if (t.type === "root") return at(e, t, n);
	if (t.type === "text") return ot(e, t);
}
function tt(e, t, n) {
	let r = e.schema, i = r;
	t.tagName.toLowerCase() === "svg" && r.space === "html" && (i = Le, e.schema = i), e.ancestors.push(t);
	let a = gt(e, t.tagName, !1), o = dt(e, t), s = pt(e, t);
	return Xe.has(t.tagName) && (s = s.filter(function(e) {
		return typeof e == "string" ? !ce(e) : !0;
...
function it(e, t, n) {
	let r = e.schema, i = r;
	t.name === "svg" && r.space === "html" && (i = Le, e.schema = i), e.ancestors.push(t);
	let a = t.name === null ? e.Fragment : gt(e, t.name, !0), o = ft(e, t), s = pt(e, t);
	return st(e, o, a, t), ct(o, s), e.ancestors.pop(), e.schema = r, e.create(t, a, o, n);
}
function at(e, t, n) {
	let r = {};
	return ct(r, pt(e, t)), e.create(t, e.Fragment, r, n);
}
function ot(e, t) {
	return t.value;
}
...
function ut(e, t) {
	return n;
	function n(n, r, i, a) {
		let o = Array.isArray(i.children), s = Be(n);
		return t(r, i, a, o, {
...
function dt(e, t) {
	let n = {}, r, i;
	for (i in t.properties) if (i !== "children" && qe.call(t.properties, i)) {
		let a = mt(e, i, t.properties[i]);
		if (a) {
			let [i, o] = a;
			e.tableCellAlignToStyle && i === "align" && typeof o == "string" && Ze.has(t.tagName) ? r = o : n[i] = o;
		}
	}
	if (r) {
...
function pt(e, t) {
	let n = [], r = -1, i = e.passKeys ? /* @__PURE__ */ new Map() : Je;
...
function mt(e, t, n) {
	...
	if (!(n == null || typeof n == "number" && Number.isNaN(n))) {
		if (Array.isArray(n) && (n = r.commaSeparated ? re(n) : Re(n)), r.property === "style") {
			let t = typeof n == "object" ? n : ht(e, String(n));
			return e.stylePropertyNameCase === "css" && (t = vt(t)), ["style", t];
		}
		return [e.elementAttributeNameCase === "react" && r.space ? ke[r.property] || r.property : r.attribute, n];
	}
}
function ht(e, t) {
	try {
		return (0, D.default)(t, { reactCompat: !0 });
	} catch (t) {
		...
		throw r.file = e.filePath || void 0, r.url = Qe + "#cannot-parse-style-attribute", r;
	}
}
function gt(e, t, n) {
	let r;
	...
	if (r.type === "Literal") {
		let t = r.value;
		return qe.call(e.components, t) ? e.components[t] : t;
	}
...
function _t(e, t) {
	...
	throw n.file = e.filePath || void 0, n.url = Qe + "#cannot-handle-mdx-estrees-without-createevaluater", n;
}
function vt(e) {
	let t = {}, n;
	for (n in e) qe.call(e, n) && (t[yt(n)] = e[n]);
	return t;
}
function yt(e) {
	let t = e.replace(Ye, bt);
...
function Ct(e, t) {
	let n = t || St;
	return wt(e, typeof n.includeImageAlt == "boolean" ? n.includeImageAlt : !0, typeof n.includeHtml == "boolean" ? n.includeHtml : !0);
}
function wt(e, t, n) {
	if (Et(e)) {
		if ("value" in e) return e.type === "html" && !n ? "" : e.value;
		if (t && "alt" in e && e.alt) return e.alt;
		if ("children" in e) return Tt(e.children, t, n);
	}
	return Array.isArray(e) ? Tt(e, t, n) : "";
}
function Tt(e, t, n) {
	let r = [], i = -1;
	for (; ++i < e.length;) r[i] = wt(e[i], t, n);
	return r.join("");
}
function Et(e) {
...
var At = {}.hasOwnProperty;
function jt(e) {
	let t = {}, n = -1;
	for (; ++n < e.length;) Mt(t, e[n]);
	return t;
}
function Mt(e, t) {
	let n;
	for (n in t) {
		let r = (At.call(e, n) ? e[n] : void 0) || (e[n] = {}), i = t[n], a;
		if (i) for (a in i) {
			At.call(r, a) || (r[a] = []);
			let e = i[a];
			Nt(r[a], Array.isArray(e) ? e : e ? [e] : []);
		}
	}
}
function Nt(e, t) {
...
var W = Ht(/[A-Za-z]/), G = Ht(/[\dA-Za-z]/), Ft = Ht(/[#-'*+\--9=?A-Z^-~]/);
function It(e) {
...
var Kt = { tokenize: Jt }, qt = { tokenize: Yt };
function Jt(e) {
	...
	function l(a) {
		...
		return t.containerState = {}, e.check(qt, u, d)(a);
	}
	function u(e) {
		return i && v(), _(r), f(e);
	}
	...
	function f(n) {
		return t.containerState = {}, e.attempt(qt, p, m)(n);
	}
	function p(e) {
...
function $t(e, t) {
	...
	for (; ++n < e.length;) if (e[n][0] === "enter" && e[n][1].type === "attentionSequence" && e[n][1]._close) {
		for (r = n; r--;) if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && t.sliceSerialize(e[r][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
			...
			]), l = H(l, Zt(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t)), l = H(l, [
				[
					"exit",
					a,
					t
...
function en(e, t) {
	let n = this.parser.constructs.attentionMarkers.null, r = this.previous, i = Xt(r), a;
	return o;
	function o(t) {
	...
	function s(o) {
		...
		let c = e.exit("attentionSequence"), l = Xt(o), u = !l || l === 2 && i || n.includes(o), d = !i || i === 2 && l || n.includes(r);
...
function mn(e, t, n) {
	...
	function u(s) {
		if (s === 59 && i) {
			...
			return o === G && !kt(r.sliceSerialize(i)) ? n(s) : (e.enter("characterReferenceMarker"), e.consume(s), e.exit("characterReferenceMarker"), e.exit("characterReference"), t);
		}
...
function _n(e, t, n) {
	...
	function d(n) {
		return n === null || K(n) ? (e.exit("codeFencedFence"), r.interrupt ? t(n) : e.check(hn, h, b)(n)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", { contentType: "string" }), f(n));
	}
	function f(t) {
	...
	function v(t) {
		return t === null || K(t) ? e.check(hn, h, b)(t) : (e.enter("codeFlowValue"), y(t));
	}
	function y(t) {
...
function xn(e, t, n) {
	...
	function o(t) {
		return t === null ? c(t) : K(t) ? e.attempt(bn, o, c)(t) : (e.enter("codeFlowValue"), s(t));
	}
	function s(t) {
...
var Dn = class {
	...
	splice(e, t, n) {
		...
		return n && On(this.left, n), i.reverse();
	}
	pop() {
	...
	pushMany(e) {
		this.setCursor(Infinity), On(this.left, e);
	}
	unshift(e) {
...
function kn(e) {
	let t = {}, n = -1, r, i, a, o, s, c, l, u = new Dn(e);
	for (; ++n < u.length;) {
		for (; n in t;) n = t[n];
		...
		if (r[0] === "enter") r[1].contentType && (Object.assign(t, An(u, n)), n = t[n], l = !0);
...
function Pn(e, t) {
	...
	function i(t) {
		return t === null ? a(t) : K(t) ? e.check(Mn, o, a)(t) : (e.consume(t), i);
	}
	function a(n) {
...
function In(e, t, n, r, i, a, o, s, c) {
	...
	function h(i) {
		return !u && (i === null || i === 41 || q(i)) ? (e.exit("chunkString"), e.exit(s), e.exit(o), e.exit(r), t(i)) : u < l && i === 40 ? (e.consume(i), u++, h) : i === 41 ? (e.consume(i), u--, h) : i === null || i === 32 || i === 40 || It(i) ? n(i) : (e.consume(i), i === 92 ? g : h);
	}
	function g(t) {
...
function Hn(e, t, n) {
	...
	function o(t) {
		return Ln.call(r, e, s, n, "definitionLabel", "definitionLabelMarker", "definitionLabelString")(t);
	}
	function s(t) {
	...
	function c(t) {
		return q(t) ? zn(e, l)(t) : l(t);
	}
	function l(t) {
		return In(e, u, n, "definitionDestination", "definitionDestinationLiteral", "definitionDestinationLiteralMarker", "definitionDestinationRaw", "definitionDestinationString")(t);
	}
	function u(t) {
		return e.attempt(Vn, d, d)(t);
	}
	function d(t) {
...
function Un(e, t, n) {
	return r;
	function r(t) {
		return q(t) ? zn(e, i)(t) : n(t);
	}
	function i(t) {
		return Rn(e, a, n, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(t);
	}
	function a(t) {
...
var Yn = /* @__PURE__ */ "address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul".split("."), Xn = [
	"pre",
	"script",
	"style",
	"textarea"
...
function tr(e, t, n) {
	...
	function d(s) {
		return s === 33 ? (e.consume(s), f) : s === 47 ? (e.consume(s), a = !0, h) : s === 63 ? (e.consume(s), i = 3, r.interrupt ? t : M) : W(s) ? (e.consume(s), o = String.fromCharCode(s), g) : n(s);
	}
	function f(a) {
		return a === 45 ? (e.consume(a), i = 2, p) : a === 91 ? (e.consume(a), i = 5, s = 0, m) : W(a) ? (e.consume(a), i = 4, r.interrupt ? t : M) : n(a);
	}
	function p(i) {
	...
	function g(s) {
		if (s === null || s === 47 || s === 62 || q(s)) {
			...
			return !c && !a && Xn.includes(l) ? (i = 1, r.interrupt ? t(s) : O(s)) : Yn.includes(o.toLowerCase()) ? (i = 6, c ? (e.consume(s), _) : r.interrupt ? t(s) : O(s)) : (i = 7, r.interrupt && !r.parser.lazy[r.now().line] ? n(s) : a ? v(s) : y(s));
		}
	...
	function O(t) {
		return t === 45 && i === 2 ? (e.consume(t), A) : t === 60 && i === 1 ? (e.consume(t), j) : t === 62 && i === 4 ? (e.consume(t), ie) : t === 63 && i === 3 ? (e.consume(t), M) : t === 93 && i === 5 ? (e.consume(t), re) : K(t) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(Qn, ae, k)(t)) : t === null || K(t) ? (e.exit("htmlFlowData"), k(t)) : (e.consume(t), O);
	}
	function k(t) {
		return e.check($n, ee, ae)(t);
	}
	function ee(t) {
	...
	function ne(t) {
		if (t === 62) {
			let n = o.toLowerCase();
			return Xn.includes(n) ? (e.consume(t), ie) : O(t);
		}
		return W(t) && o.length < 8 ? (e.consume(t), o += String.fromCharCode(t), ne) : O(t);
	}
	function re(t) {
		return t === 93 ? (e.consume(t), M) : O(t);
	}
	function M(t) {
		return t === 62 ? (e.consume(t), ie) : t === 45 && i === 2 ? (e.consume(t), M) : O(t);
	}
	function ie(t) {
		return t === null || K(t) ? (e.exit("htmlFlowData"), ae(t)) : (e.consume(t), ie);
	}
	function ae(n) {
...
function rr(e, t, n) {
	return r;
	function r(r) {
		return e.enter("lineEnding"), e.consume(r), e.exit("lineEnding"), e.attempt(an, t, n);
	}
}
//#endregion
...
function ar(e, t, n) {
	...
	function ne(t) {
		return J(t) ? Y(e, re, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(t) : re(t);
	}
	function re(t) {
...
var or = {
	...
	resolveTo: dr,
	tokenize: fr
}, sr = { tokenize: pr }, cr = { tokenize: mr }, lr = { tokenize: hr };
function ur(e) {
	let t = -1, n = [];
	for (; ++t < e.length;) {
		let r = e[t][1];
...
function dr(e, t) {
	...
	return s = [[
		...
		u,
		t
	]]), s = H(s, Zt(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t)), s = H(s, [
		[
			"exit",
			u,
			t
...
function pr(e, t, n) {
	...
	function i(t) {
		return q(t) ? zn(e, a)(t) : a(t);
	}
	function a(t) {
		return t === 41 ? u(t) : In(e, o, s, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(t);
	}
	function o(t) {
		return q(t) ? zn(e, c)(t) : u(t);
	}
	function s(e) {
		return n(e);
	}
	function c(t) {
		return t === 34 || t === 39 || t === 40 ? Rn(e, l, n, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(t) : u(t);
	}
	function l(t) {
		return q(t) ? zn(e, u)(t) : u(t);
	}
	function u(r) {
...
function mr(e, t, n) {
	...
	return i;
	function i(t) {
		return Ln.call(r, e, a, o, "reference", "referenceMarker", "referenceString")(t);
	}
	function a(e) {
...
function Er(e, t, n) {
	...
	function s(t) {
		...
		if (i === "listUnordered" ? !r.containerState.marker || t === r.containerState.marker : Lt(t)) {
			if (r.containerState.type || (r.containerState.type = i, e.enter(i, { _container: !0 })), i === "listUnordered") return e.enter("listItemPrefix"), t === 42 || t === 45 ? e.check(Sr, n, l)(t) : l(t);
	...
	function l(t) {
		return e.enter("listItemMarker"), e.consume(t), e.exit("listItemMarker"), r.containerState.marker = r.containerState.marker || t, e.check(an, r.interrupt ? n : u, e.attempt(wr, f, d));
	}
	function u(e) {
...
function Dr(e, t, n) {
	let r = this;
	return r.containerState._closeFlow = void 0, e.check(an, i, a);
	function i(n) {
	...
	function a(n) {
		return r.containerState.furtherBlankLines || !J(n) ? (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, o(n)) : (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, e.attempt(Tr, t, o)(n));
	}
	function o(i) {
...
var Pr = { tokenize: Fr };
function Fr(e) {
	let t = this, n = e.attempt(an, r, e.attempt(this.parser.constructs.flowInitial, i, Y(e, e.attempt(this.parser.constructs.flow, i, e.attempt(jn, i)), "linePrefix")));
	return n;
	function r(r) {
		if (r === null) {
			e.consume(r);
...
var Hr = /* @__PURE__ */ n({
	...
	95: Qt,
	96: Cn
}, Yr = { null: [Qt, Ir] }, Xr = { null: [42, 95] }, Zr = { null: [] };
//#endregion
...
function Qr(e, t, n) {
	...
	function d(e) {
		return o = H(o, e), g(), o[o.length - 1] === null ? (w(t, 0), l.events = Zt(a, l.events, l), l.events) : [];
	}
	function f(e, t) {
		return ei(p(e), t);
	}
...
function si(e, t, n) {
	...
	if (n.charCodeAt(0) === 35) {
		...
		return Pt(n.slice(t ? 2 : 1), t ? 16 : 10);
	}
	return kt(n) || e;
}
//#endregion
...
function ui(e) {
	...
	function l(e, t) {
		...
		else throw Error("Cannot close `" + e.type + "` (" + Ue({
			start: e.start,
			end: e.end
		}) + "): it’s not open");
	...
	function ne(e) {
		...
		n.label = oi(t), n.identifier = U(t).toLowerCase();
	}
	function re() {
	...
	function le(e) {
		...
		n ? (r = Pt(t, n === "characterReferenceMarkerNumeric" ? 10 : 16), this.data.characterReferenceType = void 0) : r = kt(t);
...
function mi(e, t) {
	throw Error(e ? "Cannot close `" + e.type + "` (" + Ue({
		start: e.start,
		end: e.end
	}) + "): a different token (`" + t.type + "`, " + Ue({
		start: t.start,
		end: t.end
	}) + ") is open" : "Cannot close document, a token (`" + t.type + "`, " + Ue({
		start: t.start,
		end: t.end
	}) + ") is still open");
}
...
function xi(e, t) {
	let n = typeof e.options.clobberPrefix == "string" ? e.options.clobberPrefix : "user-content-", r = String(t.identifier).toUpperCase(), i = Ut(r.toLowerCase()), a = e.footnoteOrder.indexOf(r), o, s = e.footnoteCounts.get(r);
...
function Li(e, t) {
	...
	if (n.length > 0) {
		let r = {
			...
			properties: {},
			children: e.wrap(n, !0)
		}, a = Be(t.children[1]), o = ze(t.children[t.children.length - 1]);
		a && o && (r.position = {
			start: a,
			end: o
		}), i.push(r);
...
function Hi(e) {
	...
	for (; r;) a.push(Ui(t.slice(i, r.index), i > 0, !0), r[0]), i = r.index + r[0].length, r = n.exec(t);
...
function Ui(e, t, n) {
	...
	if (t) {
		...
		for (; t === Bi || t === Vi;) r++, t = e.codePointAt(r);
	}
	if (n) {
		let t = e.codePointAt(i - 1);
		for (; t === Bi || t === Vi;) i--, t = e.codePointAt(i - 1);
	}
...
var Ki = {
	...
	yaml: qi,
	definition: qi,
	footnoteDefinition: qi
};
function qi() {}
//#endregion
//#region node_modules/@ungap/structured-clone/esm/deserialize.js
var Ji = typeof self == "object" ? self : globalThis, Yi = (e, t) => {
	switch (e) {
		case "Function":
		case "SharedWorker":
		case "Worker":
	...
	return r;
}, Zi = (e) => Xi(/* @__PURE__ */ new Map(), e)(0), Qi = "", { toString: $i } = {}, { keys: ea } = Object, ta = (e) => {
	let t = typeof e;
	if (t !== "object" || !e) return [0, t];
	let n = $i.call(e).slice(8, -1);
	switch (n) {
		case "Array": return [1, Qi];
		case "Object": return [2, Qi];
		case "Date": return [3, Qi];
		case "RegExp": return [4, Qi];
		case "Map": return [5, Qi];
		case "Set": return [6, Qi];
		case "DataView": return [1, n];
	}
	return n.includes("Array") ? [1, n] : n.includes("Error") ? [7, n] : [2, n];
}, na = ([e, t]) => e === 0 && (t === "function" || t === "symbol"), ra = (e, t, n, r) => {
	let i = (e, t) => {
		let i = r.push(e) - 1;
		return n.set(t, i), i;
	}, a = (r) => {
		...
		switch (o) {
			...
			case 2: {
				...
				let n = [], c = i([o, n], r);
				for (let t of ea(r)) (e || !na(ta(r[t]))) && n.push([a(t), a(r[t])]);
				return c;
			}
			...
			case 5: {
				let t = [], n = i([o, t], r);
				for (let [n, i] of r) (e || !(na(ta(n)) || na(ta(i)))) && t.push([a(n), a(i)]);
				return n;
			}
			case 6: {
				let t = [], n = i([o, t], r);
				for (let n of r) (e || !na(ta(n))) && t.push(a(n));
				return n;
			}
		}
		let { message: c } = r;
	...
	let r = [];
	return ra(!(t || n), !!t, /* @__PURE__ */ new Map(), r)(e), r;
}, aa = typeof structuredClone == "function" ? (e, t) => t && ("json" in t || "lossy" in t) ? Zi(ia(e, t)) : structuredClone(e) : (e, t) => Zi(ia(e, t));
//#endregion
...
function ca(e) {
	let t = typeof e.options.clobberPrefix == "string" ? e.options.clobberPrefix : "user-content-", n = e.options.footnoteBackContent || oa, r = e.options.footnoteBackLabel || sa, i = e.options.footnoteLabel || "Footnotes", a = e.options.footnoteLabelTagName || "h2", o = e.options.footnoteLabelProperties || { className: ["sr-only"] }, s = [], c = -1;
	for (; ++c < e.footnoteOrder.length;) {
		let i = e.footnoteById.get(e.footnoteOrder[c]);
		if (!i) continue;
		let a = e.all(i), o = String(i.identifier).toUpperCase(), l = Ut(o.toLowerCase()), u = 0, d = [], f = e.footnoteCounts.get(o);
		for (; f !== void 0 && ++u <= f;) {
			d.length > 0 && d.push({
				type: "text",
				value: " "
...
var la = (function(e) {
	...
	if (typeof e == "object") return Array.isArray(e) ? ua(e) : da(e);
	if (typeof e == "string") return fa(e);
	throw Error("Expected function, string, or object as test");
});
function ua(e) {
	let t = [], n = -1;
	for (; ++n < e.length;) t[n] = la(e[n]);
	return pa(r);
	function r(...e) {
		let n = -1;
...
function va(e, t, n, r) {
	...
	function s(e, i, c) {
		...
		if (typeof l.type == "string") {
			...
			Object.defineProperty(u, "name", { value: "node (" + ga(e.type + (t ? "<" + t + ">" : "")) + ")" });
		}
		return u;
		function u() {
			let l = _a, u, d, f;
			if ((!t || a(e, i, c[c.length - 1] || void 0)) && (l = ya(n(e, c)), l[0] === !1)) return l;
...
function ya(e) {
	return Array.isArray(e) ? e : typeof e == "number" ? [!0, e] : e == null ? _a : [e];
}
//#endregion
//#region node_modules/unist-util-visit/lib/index.js
function ba(e, t, n, r) {
	let i, a, o;
	typeof t == "function" && typeof n != "function" ? (a = void 0, o = t, i = n) : (a = t, o = n, i = r), va(e, a, s, i);
	function s(e, t) {
...
var xa = {}.hasOwnProperty, Sa = {};
function Ca(e, t) {
	let n = t || Sa, r = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), a = {
		all: s,
		applyData: Ta,
		definitionById: r,
		footnoteById: i,
	...
	function o(e, t) {
		...
		if (xa.call(a.handlers, n) && r) return r(a, e, t);
		if (a.options.passThrough && a.options.passThrough.includes(n)) {
			if ("children" in e) {
				let { children: t, ...n } = e, r = aa(n);
				return r.children = a.all(e), r;
			}
			return aa(e);
		}
		return (a.options.unknownHandler || Ea)(a, e, t);
	}
	function s(e) {
		let t = [];
		if ("children" in e) {
			...
			for (; ++r < n.length;) {
				let i = a.one(n[r], e);
				if (i) {
					if (r && n[r - 1].type === "break" && (!Array.isArray(i) && i.type === "text" && (i.value = Oa(i.value)), !Array.isArray(i) && i.type === "element")) {
						let e = i.children[0];
...
function Ta(e, t) {
	...
	if (e && e.data) {
		...
		}), n.type === "element" && i && Object.assign(n.properties, aa(i)), "children" in n && n.children && r != null && (n.children = r);
	}
	return n;
}
function Ea(e, t) {
	let n = t.data || {}, r = "value" in t && !(xa.call(n, "hProperties") || xa.call(n, "hChildren")) ? {
		type: "text",
		value: t.value
	} : {
		type: "element",
...
function ka(e, t) {
	let n = Ca(e, t), r = n.one(e, void 0), i = ca(n), a = Array.isArray(r) ? {
		type: "root",
		children: r
	} : r || {
		type: "root",
...
var Ma = /* @__PURE__ */ t((/* @__PURE__ */ r(((e, t) => {
...
function za(...e) {
	let t = -1, n;
	for (; ++t < e.length;) Ha(e[t]), e[t] && (n = n === void 0 ? e[t] : n + "/" + e[t]);
	return n === void 0 ? "." : Ba(n);
}
function Ba(e) {
	Ha(e);
	let t = e.codePointAt(0) === 47, n = Va(e, !t);
...
var Ja = [
	...
	constructor(e) {
		let t;
		t = e ? Ga(e) ? { path: e } : typeof e == "string" || $a(e) ? { value: e } : e : {}, this.cwd = "cwd" in t ? "" : Ua.cwd(), this.data = {}, this.history = [], this.messages = [], this.value, this.map, this.result, this.stored;
		let n = -1;
		for (; ++n < Ja.length;) {
			let e = Ja[n];
		...
		let r;
		for (r in t) Ja.includes(r) || (this[r] = t[r]);
	}
	get basename() {
		return typeof this.path == "string" ? Z.basename(this.path) : void 0;
	}
	set basename(e) {
		Za(e, "basename"), Xa(e, "basename"), this.path = Z.join(this.dirname || "", e);
	}
	get dirname() {
		return typeof this.path == "string" ? Z.dirname(this.path) : void 0;
	}
	set dirname(e) {
		Qa(this.basename, "dirname"), this.path = Z.join(e || "", this.basename);
	}
	get extname() {
		return typeof this.path == "string" ? Z.extname(this.path) : void 0;
	}
	set extname(e) {
		if (Xa(e, "extname"), Qa(this.dirname, "extname"), e) {
	...
	set path(e) {
		Ga(e) && (e = Ka(e)), Za(e, "path"), this.path !== e && this.history.push(e);
	}
	get stem() {
		return typeof this.path == "string" ? Z.basename(this.path, this.extname) : void 0;
	}
	set stem(e) {
		Za(e, "stem"), Xa(e, "stem"), this.path = Z.join(this.dirname || "", e + (this.extname || ""));
	}
	fail(e, t, n) {
...
function Xa(e, t) {
	if (e && e.includes(Z.sep)) throw Error("`" + t + "` cannot be a path: did not expect `" + Z.sep + "`");
}
function Za(e, t) {
...
var eo = (function(e) {
...
}), to = {}.hasOwnProperty, no = new class e extends eo {
	constructor() {
		super("copy"), this.Compiler = void 0, this.Parser = void 0, this.attachers = [], this.compiler = void 0, this.freezeIndex = -1, this.frozen = void 0, this.namespace = {}, this.parser = void 0, this.transformers = Pa();
	}
	copy() {
		let t = new e(), n = -1;
		...
		return t.data((0, Ma.default)(!0, {}, this.namespace)), t;
	}
	data(e, t) {
	...
	use(e, ...t) {
		...
		function a(e) {
			...
			o(e.plugins), e.settings && (r.settings = (0, Ma.default)(!0, r.settings, e.settings));
		}
		function o(e) {
			let t = -1;
		...
		function s(e, t) {
			...
			if (i === -1) n.push([e, ...t]);
				...
				let [r, ...a] = t, o = n[i][1];
				Na(o) && Na(r) && (r = (0, Ma.default)(!0, o, r)), n[i] = [
					e,
					r,
					...a
				];
...
function oo(e) {
	if (!Na(e) || typeof e.type != "string") throw TypeError("Expected node, got `" + e + "`");
}
function so(e, t, n) {
	if (!n) throw Error("`" + e + "` finished async. Use `" + t + "` instead");
}
function co(e) {
	return lo(e) ? e : new Ya(e);
}
function lo(e) {
...
function vo(e) {
	...
	return no().use(hi).use(n).use(Aa, r).use(t);
}
function yo(e) {
	let t = e.children || "", n = new Ya();
...
function bo(e, t) {
	...
	function l(e, t, i) {
		...
		if (e.type === "element") {
			let t;
			for (t in xt) if (Object.hasOwn(xt, t) && Object.hasOwn(e.properties, t)) {
				let n = e.properties[t], r = xt[t];
...
function wo(e, t, n) {
	let r = la((n || {}).ignore || []), i = To(t), a = -1;
	for (; ++a < i.length;) va(e, "text", o);
	function o(e, t) {
		let n = -1, i;
		for (; ++n < t.length;) {
...
function Ms(e, t) {
	...
	}), !!((!e.depth || e.depth < 3) && Ct(e) && (t.options.setext || n));
}
//#endregion
...
for (var Pc = 48; Pc < 123;) $[Pc] = Q, Pc++, Pc === 58 ? Pc = 65 : Pc === 91 && (Pc = 97);
$[43] = Q, $[45] = Q, $[46] = Q, $[95] = Q, $[72] = [Q, Mc], $[104] = [Q, Mc], $[87] = [Q, jc], $[119] = [Q, jc];
function Fc(e, t, n) {
	let r = this, i, a;
	return o;
	function o(t) {
	...
	function c(t) {
		return t === 46 ? e.check(Ac, u, l)(t) : t === 45 || t === 95 || G(t) ? (a = !0, e.consume(t), c) : u(t);
	}
	function l(t) {
...
function Ic(e, t, n) {
	...
	return i;
	function i(t) {
		return t !== 87 && t !== 119 || !Uc.call(r, r.previous) || qc(r.events) ? n(t) : (e.enter("literalAutolink"), e.enter("literalAutolinkWww"), e.check(Ec, e.attempt(Dc, e.attempt(Oc, a), n), n)(t));
	}
	function a(n) {
...
function Lc(e, t, n) {
	...
	function l(t) {
		return t === null || It(t) || q(t) || Vt(t) || Bt(t) ? n(t) : e.attempt(Dc, e.attempt(Oc, u), n)(t);
	}
	function u(n) {
...
function zc(e, t, n) {
	...
	return o;
	function o(t) {
		return t === 46 || t === 95 ? e.check(kc, c, s)(t) : t === null || q(t) || Vt(t) || t !== 45 && Bt(t) ? c(t) : (a = !0, e.consume(t), o);
	}
	function s(t) {
...
function Bc(e, t) {
	...
	return i;
	function i(o) {
		return o === 40 ? (n++, e.consume(o), i) : o === 41 && r < n ? a(o) : o === 33 || o === 34 || o === 38 || o === 39 || o === 41 || o === 42 || o === 44 || o === 46 || o === 58 || o === 59 || o === 60 || o === 63 || o === 93 || o === 95 || o === 126 ? e.check(kc, t, a)(o) : o === null || q(o) || Vt(o) ? t(o) : (e.consume(o), i);
	}
	function a(t) {
...
function Vc(e, t, n) {
	return r;
	function r(o) {
		return o === 33 || o === 34 || o === 39 || o === 41 || o === 42 || o === 44 || o === 46 || o === 58 || o === 59 || o === 63 || o === 95 || o === 126 ? (e.consume(o), r) : o === 38 ? (e.consume(o), a) : o === 93 ? (e.consume(o), i) : o === 60 || o === null || q(o) || Vt(o) ? t(o) : n(o);
	}
	function i(e) {
		return e === null || e === 40 || e === 91 || q(e) || Vt(e) ? t(e) : r(e);
	}
	function a(e) {
		return W(e) ? o(e) : n(e);
	}
...
function el(e, t, n) {
	return e.check(an, t, e.attempt(Jc, t, n));
}
function tl(e) {
...
function rl(e) {
	...
	function r(e, t) {
		...
		for (; ++n < e.length;) if (e[n][0] === "enter" && e[n][1].type === "strikethroughSequenceTemporary" && e[n][1]._close) {
			...
			for (; r--;) if (e[r][0] === "exit" && e[r][1].type === "strikethroughSequenceTemporary" && e[r][1]._open && e[n][1].end.offset - e[n][1].start.offset === e[r][1].end.offset - e[r][1].start.offset) {
				...
				s && V(o, o.length, 0, Zt(s, e.slice(r + 1, n), t)), V(o, o.length, 0, [
					[
						"exit",
						a,
						t
	...
	function i(e, n, r) {
		...
		function c(a) {
			...
			if (o < 2 && !t) return r(a);
			let l = e.exit("strikethroughSequenceTemporary"), u = Xt(a);
...
function ll(e, t) {
	...
	for (; ++n < e.length;) {
		...
		p[0] === "enter" ? m.type === "tableHead" ? (s = !1, c !== 0 && (dl(f, t, c, l, u), u = void 0, c = 0), l = {
			...
			u,
			t
		]])), i = m.type === "tableDelimiterRow" ? 2 : u ? 3 : 1) : i && (m.type === "data" || m.type === "tableDelimiterMarker" || m.type === "tableDelimiterFiller") ? (r = !1, o[2] === 0 && (a[1] !== 0 && (o[0] = o[1], d = ul(f, t, a, i, void 0, d), a = [
			0,
			0,
			0,
			0
		]), o[2] = n)) : m.type === "tableCellDivider" && (r ? r = !1 : (a[1] !== 0 && (o[0] = o[1], d = ul(f, t, a, i, void 0, d)), a = o, o = [
			a[1],
			n,
			0,
			0
		])) : m.type === "tableHead" ? (s = !0, c = n) : m.type === "tableRow" || m.type === "tableDelimiterRow" ? (c = n, a[1] === 0 ? o[1] !== 0 && (d = ul(f, t, o, i, n, d)) : (o[0] = o[1], d = ul(f, t, a, i, n, d)), i = 0) : i && (m.type === "data" || m.type === "tableDelimiterMarker" || m.type === "tableDelimiterFiller") && (o[3] = n);
	}
	for (c !== 0 && dl(f, t, c, l, u), f.consume(t.events), n = -1; ++n < t.events.length;) {
		let e = t.events[n];
		e[0] === "enter" && e[1].type === "table" && (e[1]._align = ol(t.events, n));
	}
	return e;
}
function ul(e, t, n, r, i, a) {
	let o = r === 1 ? "tableHeader" : r === 2 ? "tableDelimiter" : "tableData";
	n[0] !== 0 && (a.end = Object.assign({}, fl(t.events, n[0])), e.add(n[0], 0, [[
		"exit",
		a,
		t
	]]));
	let s = fl(t.events, n[1]);
	if (a = {
		type: o,
		...
		let i = fl(t.events, n[2]), a = fl(t.events, n[3]), o = {
			type: "tableContent",
	...
	return i !== void 0 && (a.end = Object.assign({}, fl(t.events, i)), e.add(i, 0, [[
		"exit",
		a,
		t
	]]), a = void 0), a;
...
function hl(e, t, n) {
	...
	function s(r) {
		return K(r) ? t(r) : J(r) ? e.check({ tokenize: gl }, t, n)(r) : n(r);
	}
}
function gl(e, t, n) {
...
function Sl({ currentLocale: t, locales: n, allowedLocales: r, onSelect: i, className: o }) {
	let c = m("languageSelector"), [l, u] = x(!1), d = b(null);
	v(() => {
		if (!l) return;
		let e = (e) => {
	...
	let g = r && r.length > 0 ? new Set(r.map((e) => e.split("-")[0].toLowerCase())) : null, _ = Array.from(new Set(n.filter(Boolean))).filter((e) => !g || g.has(e.split("-")[0].toLowerCase()));
	if (_.length <= 1) return null;
	let y = t.split("-")[0].toLowerCase();
	return /* @__PURE__ */ w("div", {
		...
		children: [
			...
			/* @__PURE__ */ w("button", {
				...
				className: h("flex w-full items-center gap-2 rounded-wx-sm border border-wx-border bg-wx-bg px-3 py-2", "text-sm font-medium text-wx-fg transition-colors hover:bg-wx-bg-elevated", "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wx-primary"),
				children: [
					/* @__PURE__ */ C(T, {
						size: 15,
					...
					/* @__PURE__ */ C(a, {
						size: 15,
						className: h("shrink-0 text-wx-fg-subtle transition-transform", l && "rotate-180")
					})
				]
			}),
			/* @__PURE__ */ C(s, { children: l && /* @__PURE__ */ C(e.ul, {
				initial: {
					opacity: 0,
					y: 4
				},
				...
				className: h("absolute bottom-full left-0 z-20 mb-1 max-h-56 w-full overflow-auto", "rounded-wx-sm border border-wx-border bg-wx-bg py-1 shadow-[0_12px_32px_rgba(0,0,0,0.16)]"),
				role: "listbox",
				children: _.map((e) => {
					let t = e.split("-")[0].toLowerCase() === y;
					return /* @__PURE__ */ C("li", { children: /* @__PURE__ */ w("button", {
						type: "button",
						role: "option",
						"aria-selected": t,
						onClick: () => {
						...
						className: h("flex w-full items-center gap-2 px-3 py-2 text-left text-sm transition-colors", t ? "font-semibold text-wx-primary" : "text-wx-fg hover:bg-wx-bg-elevated"),
...
var Ol = (e, t) => `wexio:reaction:${e}:${t}`, kl = [
	{
		slotIndex: 0,
		emoji: "🎉"
	},
...
function jl({ surface: t, itemId: n, reactionCounts: r, viewerReaction: a, groupItemIds: o, readonly: s = !1, showCounts: c = !0, isDummy: l = !1, className: u }) {
	let d = m("reactions"), f = i(), { data: p, loading: g } = Tl({
		variables: { surface: t },
		fetchPolicy: "cache-first",
		skip: l
	}), [b, { loading: S }] = Dl(), T = y(() => l ? kl : p?.visitorReactionSet?.slots ?? [], [l, p]), E = l ? !0 : p?.visitorReactionSet?.enabled ?? !0, D = Ol(t, n), [O, k] = x(null);
	v(() => {
		if (!l) {
			k(a ?? null);
			return;
	...
	let [ee, te] = x({}), A = (e) => (r?.[String(e)] ?? 0) + (l ? ee[e] ?? 0 : 0), j = _((e, r) => {
		let i = Al[t], a = o?.length ? o : [n];
		for (let t of a) {
		...
		let r = O;
		if (k(e), l) {
			typeof window < "u" && window.localStorage.setItem(D, String(e)), te((t) => ({
				...t,
				[e]: (t[e] ?? 0) + 1,
				...r === null ? {} : { [r]: (t[r] ?? 0) - 1 }
			}));
	...
	return g || !E || T.length === 0 ? null : /* @__PURE__ */ C("div", {
		className: h("flex flex-wrap items-center justify-center gap-2", u),
		role: "group",
		"aria-label": d("ariaLabel"),
		children: T.map((t) => {
			let n = O === t.slotIndex, r = A(t.slotIndex);
			return /* @__PURE__ */ w(e.button, {
				type: "button",
				disabled: s || S,
				onClick: () => void ne(t.slotIndex),
				whileTap: { scale: .9 },
				...
				className: h("flex items-center gap-1.5 rounded-full px-3 py-1.5 text-2xl leading-none transition-colors", "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-wx-primary", n ? "bg-wx-primary/10 ring-1 ring-wx-primary/40" : "hover:bg-wx-bg-elevated", s && "cursor-default opacity-70"),
				"aria-pressed": n,
				"aria-label": d("tapAria", { emoji: t.emoji }),
				children: [/* @__PURE__ */ C("span", {
					"aria-hidden": "true",
					children: t.emoji
				}), c && r > 0 && /* @__PURE__ */ C("span", {
...
//#endregion
export { ne as a, k as c, te as i, E as l, Sl as n, ee as o, xl as r, O as s, jl as t };

//# sourceMappingURL=widget-react-CPnUEeex.js.map