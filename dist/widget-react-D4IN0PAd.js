...
//#endregion
//#region lib/api.ts
var Do = "https://api.wexio.io", Oo = "http://localhost:3001", ko = "https://local.api.wexio.io:3443";
function Ao() {
	let e = jo("NEXT_PUBLIC_WEXIO_API_URL");
	if (e) return e;
	if (typeof window < "u") {
		let { protocol: e, hostname: t } = window.location;
		if (e === "https:" && /^local\.[a-z-]+\.wexio\.io$/i.test(t)) return ko;
		if (e === "https:" && /\.wexio\.io$/i.test(t)) {
			let e = t.replace(/^(app|templates)\./i, "api.").replace(/\.(app|templates)\./i, ".api.");
			return e === t ? Do : `https://${e}`;
		}
		if (t === "localhost" || t === "127.0.0.1" || t === "[::1]") return Oo;
	}
	return Do;
}
function jo(e) {
...
function Mo() {
	return jo("NEXT_PUBLIC_WEXIO_DEMO_PK");
}
...
function Po(e, t) {
	...
	let i = (async () => {
		try {
			let n = new URL(`${Ao()}/api/web/config/${encodeURIComponent(e)}`);
...
function Vo(e) {
	...
	let n = (async () => {
		try {
			let t = new URL(`${Ao()}/api/web/config/${encodeURIComponent(e)}`);
...
var Uo = _(null);
function Wo({ env: e, children: t }) {
	return /* @__PURE__ */ w(Uo.Provider, {
		value: e,
		children: t
	});
}
...
function Qo() {
	...
	b(() => {
		let n = new URL(window.location.href), i = n.searchParams.get("pk") ?? void 0, o = n.searchParams.get("mode"), s = e.modeOverride === "demo", c = s ? void 0 : Mo() || void 0, l = s ? void 0 : e.publicKeyOverride ?? i ?? c, u = l === "pk_demo" ? void 0 : l, d = e.modeOverride ?? (u ? "production" : o === "preview" ? "preview" : "demo"), f = !1;
		if ((async () => {
			if (e.configBase) {
				let t = u ? await Vo(u) : null;
				if (f) return;
...
function Tc({ items: e, initialIndex: t, open: r, onClose: i }) {
	let a = d("lightbox"), [o, s] = C(t), c = Go(), l = !(c.embedded ?? !1) || (c.lightboxViewport ?? !0);
	b(() => {
		r && s(t);
	}, [r, t]);
